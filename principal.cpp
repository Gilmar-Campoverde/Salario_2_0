...
void Principal::on_actionGuardar_triggered(){
    ...
    QString fileName = QFileDialog::getSaveFileName(this,tr("Guardar Archivo").arg(pathArchivo),
    ...
    if(!f.open(QIODevice::WriteOnly | QIODevice::Append)){
        ...
        QMessageBox::warning(this,tr("Salarios"),tr("No se puede abrir el archivo").arg(fileName));
    ...
    ui->statusbar->showMessage(tr("Archivo guardado en").arg(fileName), 3000);
}
